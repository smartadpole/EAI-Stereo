...
from core.eai_stereo import EAIStereo
...
def train(args):
    model = nn.DataParallel(EAIStereo(args))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_ckpt', help="restore checkpoint",
                        default='/your_path/checkpoints_sceneflow/eai-stereo.pth')
    ...
    parser.add_argument('--image_size', type=int, nargs='+', default=[320, 1024],
